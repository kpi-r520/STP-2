...
**Графический редактор (proxy, prototype, decorator, bridge, flyweight)**
...
**Аудио-редактор (singleton, adapter, observer, mediator, composite)**
...
**Web-browser (proxy, chain of responsibility, factory method, template method, visitor)**
...
**Powershell terminal (strategy, command, abstract factory, bridge, interpreter)**
...
**Sql IDE (singleton, command, observer, bridge, visitor)**
...
**CI server (state, command, decorator, mediator, visitor)**
...
**Office communicator (strategy, adapter, abstract factory, bridge, composite)**
...
**E-mail client (singleton, builder, decorator, template method, interpreter)**
...
**NAnt script builder (proxy, chain of responsibility, decorator, mediator, flyweight)**
...
**Mind-mapping software (strategy, prototype, abstract factory, bridge, composite)**
...
**Project Management software (proxy, chain of responsibility, abstract factory, bridge, flyweight)**
...
**Installer generator (iterator, builder, factory method, bridge, interpreter)**
...
**Табличный редактор (excel-like) (strategy, command, observer, mediator, flyweight)**
...
**Редактор презентаций (powerpoint-like) (proxy, prototype, abstract factory, template method, composite)**
...
**Видео-проигрыватель (iterator, command, observer, bridge, interpreter)**
...
**Torrent клиент (state, command, decorator, mediator, visitor)**
...
**Средство сравнения и слияния файлов (strategy, builder, factory method, façade, interpreter)**
...
**Программа для создания заметок (OneNote) (strategy, prototype, observer, bridge, flyweight)**
...
**Дизайнер Отчетов (proxy, adapter, abstract factory, template method, composite)**
...
**СУБД (singleton, command, decorator, façade,interpreter)**
